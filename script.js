...
window.addEventListener("wheel",(e)=>{
    ...
    if(bool){
        (document.querySelector(`.section-${deltaY ? counter1: counter2}`
...
document.querySelector(".grape-image").addEventListener("mouseover",()=>{
    document.querySelector(".section-3-wrapper").style.opacity = '.5';
})
document.querySelector(".grape-image").addEventListener("mouseout",()=>{
